...
export default function ServiceRatingPage() {
    ...
    const fetchServiceDetails = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_API_URL}/api/ratings/request/${requestId}/`
        );
  ...
  useEffect(() => {
    const fetchRatings = async () => {
      ...
      try {
        const response = await fetch(
          `${process.env.REACT_APP_API_URL}/api/ratings/firms/${firmId}/ratings`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/ratings/firms/${firmId}/rate`,
        {
          method: "POST",
          headers: {
