...
//                 image={
//                   "process.env.REACT_APP_API_URL" + firm.image ||
//                   "process.env.REACT_APP_API_URL/uploads/profile-images/DefualtUserPicture.jpg"
//                 } //
...
function FirmsPage() {
    ...
    const fetchCriteria = async () => {
      try {
        const response = await fetch(
          `${process.env.REACT_APP_API_URL}/api/client/filterCriteria`
        );
  ...
  const handleApplyFilters = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/client/search`,
        {
          method: "POST",
          headers: {
          ...
          {currentCards.map((firm, index) => {
            return (
              <FirmCard
                ...
                image={
                  `${process.env.REACT_APP_API_URL}` + firm.image ||
                  `${process.env.REACT_APP_API_URL}/uploads/DefualtUserPicture.jpg`
                }
                isVerified={false || false}
                onClick={
                  () => navigate(`/FirmProfile/${firm._id}`) //to be edited
