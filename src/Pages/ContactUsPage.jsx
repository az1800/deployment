        ...
        <div class="grid lg:grid-cols-3 items-center">
          <div class="grid grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
            <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              ...
              <h4 class="text-gray-800 text-sm font-bold mt-4">Visit office</h4>
            ...
            <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              ...
              <h4 class="text-gray-800 text-sm font-bold mt-4">Call us</h4>
              <p class="text-xs text-gray-600 mt-1">+158 996 888</p>
            </div>
            <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <h4 class="text-gray-800 text-sm font-bold mt-4">Chat to us</h4>
              <p class="text-xs text-gray-600 mt-1">info@example.com</p>
            </div>
            <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <h4 class="text-gray-800 text-sm font-bold mt-4">Fax</h4>
              <p class="text-xs text-gray-600 mt-1">+1-548-2588</p>
            </div>
          </div>

          <div class="lg:col-span-2 bg-gradient-to-r from-[rgba(91,184,255,1)] via-[rgba(91,184,255,0.8)] to-[rgba(91,184,255,0.6)] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8 ">
            <h2 class="text-2xl sm:text-3xl text-white text-center font-bold mb-6">
              Contact us
            </h2>
            <form>
              <div class="max-w-md mx-auto space-y-2">
                <input
                  type="text"
                  placeholder="Name"
                  class="w-full bg-white rounded-md py-3 px-4 text-sm outline-none"
                />
                <input
                  type="email"
                  placeholder="Email"
                ...
                <textarea
                  placeholder="Message"
                  rows="6"
                  class="w-full bg-white rounded-md px-4 text-sm pt-3 outline-none"
                ></textarea>
                <button
                  type="button"
                  class="text-white w-full relative bg-black hover:bg-[#111] rounded-md text-sm px-6 py-3 !mt-4"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16px"
