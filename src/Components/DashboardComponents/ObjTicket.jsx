...
const fakeTickets = [
  {
    _id: "1",
    issueTitle: "Technical Issues",
    customIssueTitle: "",
    issueDescription: "System is crashing during file uploads.",
    attachments: ["/uploads/screenshot1.png"],
    timestamp: "2025-03-21T10:15:00Z",
    status: "pending",
    sender: { name: "Ali Salman" },
    receiver: { name: "Support Team" },
    service: { name: "Cloud Storage" },
    budget: 1200,
    originalDescription: "Need help with uploading files.",
    resolution: null,
  },
  {
    _id: "2",
    issueTitle: "Other",
    customIssueTitle: "Backend API Timeout",
    issueDescription: "Our API calls are timing out during peak hours.",
    attachments: [],
    timestamp: "2025-03-19T08:00:00Z",
    status: "under-review",
    sender: { name: "Fatima Noor" },
    receiver: { name: "Tech Ops" },
    service: { name: "API Gateway" },
    budget: 3000,
    originalDescription: "Investigate API slowdown.",
    resolution: "Optimization in progress. ETA 2 days.",
  },
  {
    _id: "3",
    issueTitle: "Payment Dispute",
    customIssueTitle: "",
    issueDescription: "Duplicate charges detected on last invoice.",
    attachments: ["/uploads/invoice1.pdf"],
    timestamp: "2025-03-20T12:30:00Z",
    status: "resolved",
    sender: { name: "Yousef Kamal" },
    receiver: { name: "Billing Dept." },
    service: { name: "Invoicing" },
    budget: 450,
    originalDescription: "Incorrect charges?",
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-sm font-semibold text-slate-900">
                    {ticket.issueTitle === "Other"
                      ? ticket.customIssueTitle
                      : ticket.issueTitle}
                  </h3>
                ...
                {ticket.originalDescription && (
                  <p className="text-xs italic text-slate-500 mb-2">
                    Original: {ticket.originalDescription}
                  </p>
                )}
                ...
                <div className="text-xs text-slate-500 mb-3">
                  ...
                  {ticket.budget && (
                    <div>
                      Budget:{" "}
                      <span className="text-slate-700">${ticket.budget}</span>
                    </div>
                  )}
                </div>
