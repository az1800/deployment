export async function SendRequest() {
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/client/firmList`,
      {
...
export async function SendRequestForFirmProfile(id) {
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/client/firmProfile?id=${id}`,
      {
        //from here u can choose the url u wnat in back-end
        method: "GET",
        headers: {
...
export async function SendRequestForFirmProfile2(id) {
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/account_firm/firmProfile`,
      {
        //from here u can choose the url u wnat in back-end
        method: "POST",
        headers: {
...
export async function sendRequestByName(searchedItem) {
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/client/firmSearch`,
      {
        //from here u can choose the url u wnat in back-end
        method: "POST",
        headers: {
